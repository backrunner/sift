...
Generate all 18 screenshots at the App Store Connect-compatible 1284 x 2778
portrait size:
...
The current render is written to `output/app-store/1.0/final-v3.0/`, preserving
